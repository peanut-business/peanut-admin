...
- PB08B 当前候选 `61d9fb7…` 在 Nginx loopback 直连探针之外，为 PHP 增加可选 bundled MySQL healthy 依赖；当前 owner 为 RC005，继承唯一 registry 构建和已通过的 24→28 前滚，只继续当前空库、Docker/HTTP、唯一浏览器与文档一致性
