...
/**
 * Execution envelope passed to a Module after an upstream identity boundary succeeds.
 * It carries the Tenant and actor kind without accepting request/payload tenant IDs.
 */
