...
final class TenantEntryBindingResolver
{
    ...
    public function __construct(
        ...
        private readonly ?\Closure $defaultSystem = null,
    ) {
    }
    ...
    public function loginTenantCode(
        ...
        $explicitTenantCode = $explicitTenantCode === null
            ? null
            : trim($explicitTenantCode);
    ...
    public function system(
        ...
        return DefaultTenantContextResolver::system($actor, $operation, $operationId);
    }
...
SQL);
        ...
        if (($row['binding_status'] ?? null) !== 'active'
            || ($row['tenant_status'] ?? null) !== 'active'
            || $tenantId < 1
            || $tenantCode === '') {
            throw new \DomainException('TENANT_ENTRY_BINDING_UNAVAILABLE');
        }
