...
use app\common\infrastructure\external\ThinkPhpExternalTenantBindingRepository;
    ...
    public function bindings(): array
    {
        return [
            ...
            OAuthCommands::class => fn(App $app): OAuthCommands => new OAuthCommandService(
                ...
                $app->make(\app\common\services\config\TenantApplicationSettingService::class),
