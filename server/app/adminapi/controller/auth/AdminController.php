...
class AdminController extends BaseAdminController
{
    ...
    public function add()    { $r = AdminLogic::add($this->request->post()); return $r ? $this->success('操作成功') : $this->fail(AdminLogic::getError()); }
    public function edit()   { $r = AdminLogic::edit($this->request->post()); return $r ? $this->success('操作成功') : $this->fail(AdminLogic::getError()); }
