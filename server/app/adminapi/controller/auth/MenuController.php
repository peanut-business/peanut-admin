...
class MenuController extends BaseAdminController
{
    ...
    public function add()    { $r = MenuLogic::add($this->request->post()); return $r ? $this->success('操作成功') : $this->fail(MenuLogic::getError()); }
    public function edit()   { $r = MenuLogic::edit($this->request->post()); return $r ? $this->success('操作成功') : $this->fail(MenuLogic::getError()); }
