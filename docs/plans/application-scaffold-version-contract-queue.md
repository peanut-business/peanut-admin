...
- 后续正式发行列车要求 `scaffold_template`、PHP Core 与 Web Core 同号并同步预发布后缀；应用
  `product_release` 与 Module 版本继续独立。当前 `3.0.13` / `0.1.0-alpha.12` 历史身份不回写。
