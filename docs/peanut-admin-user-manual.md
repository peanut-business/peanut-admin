...
- 已支付且仍有可退款余额的记录显示“退款”；未支付或累计退款已达订单金额时入口禁用。
...
- 退款可指定不超过当前可退款余额的金额；同一充值单允许多次部分退款，省略金额时退还剩余全部金额。每笔退款独立扣减余额、写入流水和退款记录。
- 渠道明确失败会保留对应退款记录。只有退款失败状态允许“重新退款”；重试只调用渠道，不会再次扣余额、累计充值或新增退款记录。
