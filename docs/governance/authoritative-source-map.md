...
| Product-closure ownership and execution state | accepted ownership decision, fixed commits, PRs and completed minimum verification | `docs/architecture/product-closure-ownership-and-adoption.md`, `docs/plans/product-closure-execution-queue.md` and `docs/product-status/product-closure-observability.md`; stable capability completion still returns to the capability ledger |
