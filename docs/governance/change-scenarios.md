...
| Resource, port or environment | resource registry | internal resource/operator guide | only public-safe localhost instructions | credentials, private host, internal candidate evidence | impact contains technical + site + generated; forbidden-public scan passes |
| Product capability status | capability ledger or immutable snapshot | internal product-status index | none by default | public developer site | impact contains technical + generated and explicitly excludes site |
