...
| Audit related history, correct rules and resume interrupted work | [逐步确认的0–6阶段方案](plans/history-rules-product-convergence-plan-2026-09-10.md), [历史决定与问题证据](maintenance/conversation-audit-2026-09-09.md), [source index](maintenance/fact-audit-2026-09-09/source-index.json) and [问题主登记](maintenance/runtime-convergence-issue-register-2026-09-09.json) | Public maintainer sources. Stages0–4 and S5-T01 local implementation are root accepted and integrated on `dev` at the recorded commit; later batches remain separately controlled, while runtime repair, qualification, release and deployment are incomplete. Root-local recovery/coverage controls are deliberately untracked and are not required by a public clone. |
