...
| Understand Module development and delivery | [Module development guide](plugin-module-development.md), [Application and Module coding standards](architecture/application-module-blueprint/coding-standards.md) and [Module publication contract](architecture/module-publication-contract.md) | accepted target layout, explicitly marked current implementation gap and bundled/package/published states |
...
| Follow the product-closure work | [ownership decision](architecture/product-closure-ownership-and-adoption.md), [compatibility baseline](architecture/product-closure-core-application-compatibility.md) and [observability panel](product-status/product-closure-observability.md) | internal decisions and execution evidence; not capability completion proof |
