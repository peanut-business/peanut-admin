...
| Understand the Core runtime direction | [Core ThinkPHP 8 运行时收敛方向 ADR](architecture/core-thinkphp-runtime-direction-adr.md) | current architecture decision; direction accepted, Runtime migration not started |
