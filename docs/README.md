...
| Review Luna Max source pre-audit candidates | [Luna Max source pre-audit register](plans/luna-max-source-preaudit-2026-09-08.md) | planned candidate register with fixed source evidence; every item requires high-level confirmation before implementation |
