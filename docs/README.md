...
| Understand the Core runtime direction | [Core ThinkPHP 8 运行时收敛方向 ADR](architecture/core-thinkphp-runtime-direction-adr.md) and [Runtime 收敛复核与执行报告](maintenance/runtime-convergence-audit-2026-09-09.md) | source-audited current decision plus machine-traceable execution audit; direction accepted, Runtime migration not complete |
