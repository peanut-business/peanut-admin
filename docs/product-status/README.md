...
> 总体状态：**进行中**。当前产品路线仍在推进。Peanut Admin v2.0.0 fresh-only 与 v2.0.1 源码正式 Release 均已完成；v2.0.1 的线上 Standalone/Multi-tenant 双部署和 Article 专项真实页面资格仍未完成。
>
> 事实基线：`main@1c8aff4f1f19069bfe4480a8b29d59414d5c6816`，复核日期：`2026-08-18`。
