...
Peanut Admin `v2.1.5` 已完成正式源码发布和部署收口；固定 tag、P0-E 7/7、GitHub Release、
生产单租户升级、多租户 Demo 部署和无秘密 post-deployment 快照均已冻结。
...
工作不再阻塞当前 Release。后续代码变更应从 v2.1.5 之后的新开发基线开始，不回写该 tag。
