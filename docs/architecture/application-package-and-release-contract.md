...
> 状态：Accepted Target，两个核心包已发布，PB04–PB06 已收口
> 日期：2026-08-11
...
7. [进行中] 系统基础设施 PB04、会员/财务 PB05、内容/装修 PB06 已完成；下一步收口通知、支付/OAuth 与渠道。核心能力只消费获准 registry 版本，产品域留在应用 Module；每域做一次最低业务验收。
