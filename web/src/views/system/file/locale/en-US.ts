export default {
  'menu.system.file': 'Material',

  'systemFile.tab.image': 'Image',
  'systemFile.tab.video': 'Video',
  'systemFile.tab.file': 'File',

  'systemFile.cate.title': 'Categories',
  'systemFile.cate.all': 'All',
  'systemFile.cate.uncategorized': 'Uncategorized',
  'systemFile.cate.addTitle': 'New Category',
  'systemFile.cate.editTitle': 'Edit Category',
  ...
  'systemFile.rename.required': 'File name is required',

  'systemFile.move.target': 'Target category',
  'systemFile.move.placeholder': 'Select a category',
