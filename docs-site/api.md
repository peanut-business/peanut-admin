...
DCS 是 Peanut Admin 脚手架生成的独立应用。Peanut 只提供 Module、Tenant、权限、审计和
Host 扩展合同；Party、Store、Warehouse、Supplier、Product、Pricing、Inventory、
Procurement 与 Trade 的接口、表和事件由 DCS 仓拥有。Peanut 中的 Product-only
