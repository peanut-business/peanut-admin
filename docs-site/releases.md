...
Peanut Admin 正在完成产品化正式基线，尚未发布应用 `1.0.0`。PB03–PB07 领域收口与 PB08A 品牌、脚手架、官网/文档门户实现已经完成；PB08B 正式候选集成验收与 PB09 发布仍未执行。
...
- PB08B：空库、升级、覆盖、registry、Docker、官网/四端桌面与移动一次正式候选验收。
- PB09：`dev` 合入并推送 `main`、版本与发布记录、许可证/provenance 决策。
