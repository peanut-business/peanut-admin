...
正式消费脚手架时使用当前正式的 `v2.1.1` Tag/Release，不从移动的 `dev` 分支或带未提交修改的
维护工作树生成应用。
...
Release、每个文件归谁所有。当前已有 `v2.0.0 -> v2.0.1` 的派生应用资格，`v2.0.1 -> v2.1.1`
...
| `ADMIN_INITIAL_PASSWORD` | 是 | 无 | 至少 12 位，同时包含字母和数字 |
